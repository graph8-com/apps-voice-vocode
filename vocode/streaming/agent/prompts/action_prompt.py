...
4. Action: update_booking. After checking bookings, take this action to update a specific booking. Necessary Action parameters: previous booking_id, new date and new time for the booking.
